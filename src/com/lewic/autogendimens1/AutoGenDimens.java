package com.lewic.autogendimens1;
...
public class AutoGenDimens {
	...
	public AutoGenDimens(int baseX, int baseY, String supportStr) {
		this.baseW = baseX;
		this.baseH = baseY;
	...
	public static void main(String[] args) {
		...
		new AutoGenDimens(baseW, baseH, addition).generate();
	}
